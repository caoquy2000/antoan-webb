"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[16],{19:function(e,t,i){i.d(t,{ad:function(){return es}});var s,r,n=i(5816),o=i(8463),h=i(3333),l=i(4444),a=i(6640);i(3454);let u="@firebase/firestore";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let d="9.22.1",p=new h.Yd("@firebase/firestore");function f(e,...t){if(p.logLevel<=h.in.DEBUG){let i=t.map(m);p.debug(`Firestore (${d}): ${e}`,...i)}}function g(e,...t){if(p.logLevel<=h.in.ERROR){let i=t.map(m);p.error(`Firestore (${d}): ${e}`,...i)}}function m(e){if("string"==typeof e)return e;try{return JSON.stringify(e)}catch(t){return e}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
